...
export var intros = {
  intro_hs: {
    title: "Head Start: Overview of Educational Technology",
    body:
      "<p>Head Start presents you with the main areas in the field, and lets you zoom into the most important publications within each area. It is intended to give researchers that are new to a field a head start on their literature review (hence the name)." +
  ...
  intro_cn3: {
    title: "Overview Visualization of EC-TEL and i-KNOW 2014",
    body:
      "<p>This visualization presents you with a topical overview of EC-TEL and i-KNOW 2014, and highlights papers that are recommended for you. You can inspect the papers within each topic, and bookmark papers of interest." +
  ...
  intro_plos: {
    title: "Overview Visualization of a PLOS Search Result",
    body:
      "<p>This visualization presents you with a topical overview of the 100 most relevant papers for your PLOS search. You can inspect the papers within each topic, and read individual papers within this interface." +
  ...
  intro_cris: {
    title:
      "Reden Sie mit! Welche Fragen zu psychischen Erkrankungen soll die Wissenschaft aufgreifen?",
  ...
  intro_cris2_en: {
    title:
      "Tell us! What questions on accidental injuries does research need to address?",
