...
const areas = (state = { list: [], size: null, options: {} } as any, action: any) => {
...
const resizeAreas = (areas: any[], currentSize: number, newSize: number, options: any) => {
...
const zoomAreas = (zoomedAreaUri: string, areas: any[], size: number, options: any) => {
