...
const FOOTER_HEIGHT: Record<string, number> = {
 ...
 */
export const getListSize = (config: Config, chartHeight?: number) => {
  if (typeof chartHeight === "undefined") {
    chartHeight = getChartSize(config).size;
  }
 ...
 */
const getRealHeight = (element: JQuery<HTMLElement>) => {
  let height = 0;
...
const getFooterHeight = (config: Config) => {
