...
const paperForce = (papers, areas, size: number, alpha, updatePapers) => {
...
const getPaperCircle = (paper: Paper) => {
  const circle = {
 ...
 */
const getPapersForceAlpha = (numOfPapers: number, config: Config) => {
 ...
 */
const getAreasForceAlpha = (numOfPapers: number, config: Config) => {
