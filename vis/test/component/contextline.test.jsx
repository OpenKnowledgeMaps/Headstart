...
describe("Context line component", () => {
  ...
  describe("small items part", () => {
    ...
    it("contains English search language (triple)", () => {
      ...
      storeObject.contextLine.showLanguage = true;
  ...
  //     expect(result.container.querySelector("#author_living_dates")).toBe(null);
  //     expect(result.container.querySelector("#author_bio")).toBe(null);
  //   });
  ...
  //     expect(
  //       result.container.querySelector("#author_living_dates").textContent
  ...
  //     expect(
  //       result.container.querySelector("#author_bio_link").getAttribute("href")
