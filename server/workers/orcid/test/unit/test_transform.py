...
from src.model import AuthorInfo, Website, ExternalIdentifier
...
def sample_author_info():
    ...
    return AuthorInfo(
        ...
        academic_age=14,
        websites=[
            Website(url_name="personal", url="http://example.com"),
            Website(url_name="institutional", url="http://institution.com")
        ],
        external_identifiers=[
            ExternalIdentifier(
                relationship="self",
                type="ResearcherID",
                url="http://researcherid.com",
                value="12345"
            ),
            ExternalIdentifier(
                relationship="self",
