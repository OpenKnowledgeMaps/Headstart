...
<html>
    ...
    <body style="margin:0px; padding:0px">
        ...
        <script>
            data_config.title = '<?php echo 'Overview of <span id="search-term-unique">' . json_encode($_GET['query']) . '</span> based on <span id="num_articles"></span> ' . json_encode($_GET['service_name']) . ' articles'; ?>';
        	data_config.files = [{
