<div class="search">
    <form id="searchform" action="#" method="POST" target="_blank">
        ...
        <div style="background-color: white; border-radius: 0px 0px 5px 5px; -webkit-box-shadow: 0 2px 2px 0 rgba(0,0,0,0.14), 0 3px 1px -2px rgba(0,0,0,0.12), 0 1px 5px 0 rgba(0,0,0,0.2);
