...
<html>
    ...
    <body style="margin:0px; padding:0px" class="vis-page">
        ...
        <script>
            ...
            let credit_text = "<p class='wtp'><a href='faqs'>Weitere Informationen finden Sie in den FAQs</a>.</p><p>Diese Visualisierung wurde mit der <a href='http://github.com/pkraker/Headstart'>Open Source Software Head Start</a> von <a href='https://openknowledgemaps.org/'>Open Knowledge Maps</a> realisiert. Alle Daten stammen aus LinkedCat+.</p>"
