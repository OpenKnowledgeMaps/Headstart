...
var setupPaginator = function (searchTerm, params) {
  ...
  paginator.pagination({
    ...
    formatAjaxError: function (jqXHR, textStatus, errorThrown) {
      $('#viper-search-results').text('An unexpected error occurred while retrieving data from OpenAIRE. The OpenAIRE API is currently experiencing problems. We have logged the error and will investigate the issue.')
